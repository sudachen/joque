...
var testSet1 = []TestData{
	...
	{"103 PUBLISH test 1 2 3\nq#12345\n\n", Message{ID: 103, Kind: MqPublish, Topic: "test", QoS: 1, Priority: 2, TTL: 3, Payload: []byte("q#12345")}},
	{"104 PUBLISH t$st 0 0 1\nfjhtqrwytr1#$%789\n\n", Message{ID: 104, Kind: MqPublish, Topic: "t$st", QoS: 0, Priority: 0, TTL: 1, Payload: []byte("fjhtqrwytr1#$%789")}},
	{"105 ACK\n\n", Message{ID: 105, Kind: MqAck}},
	{"106 QUERY\n\n", Message{ID: 106, Kind: MqQuery}},
	{"107 COMPLETE\n@#12345\n\n", Message{ID: 107, Kind: MqComplete, Payload: []byte("@#12345")}},
	{"108 PUBLISH test 1 2 3\n\n", Message{ID: 108, Kind: MqPublish, Topic: "test", QoS: 1, Priority: 2, TTL: 3, Payload: nil}},
...
var testSet11 = []TestData{
	...
	{"102   SUBSCRIBE t$st  \n\n", Message{ID: 102, Kind: MqSubscribe, Topic: "t$st"}},
	{"103 PUBLISH  test 1 2  3\nq#12345\n\n", Message{ID: 103, Kind: MqPublish, Topic: "test", QoS: 1, Priority: 2, TTL: 3, Payload: []byte("q#12345")}},
	{"104 PUBLISH t$st  0  0 3 \nfjhtqrwytr1#$%789\n\n", Message{ID: 104, Kind: MqPublish, Topic: "t$st", QoS: 0, Priority: 0, TTL: 3, Payload: []byte("fjhtqrwytr1#$%789")}},
	{"  105   ACK  \n\n", Message{ID: 105, Kind: MqAck}},
	{"106  QUERY \n\n", Message{ID: 106, Kind: MqQuery}},
	{"107 COMPLETE \n@#12345\n\n", Message{ID: 107, Kind: MqComplete, Payload: []byte("@#12345")}},
	{"108 PUBLISH test  1 2 3 \n\n", Message{ID: 108, Kind: MqPublish, Topic: "test", QoS: 1, Priority: 2, TTL: 3, Payload: nil}},
